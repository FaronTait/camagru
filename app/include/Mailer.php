		...
		if (is_array($params) && !empty($params)) {
			...
			*/
			...
			$message = '
		      ...
		      <body>
			      <h3 style="color: teal; text-align: center;">Hello ' . $params['name'] . ', ' .  $params['commenter'] . ' commented on your image' . '</h3>
		...
		if (is_array($params) && !empty($params)) {
			...
			*/
			...
			$message = '
		      ...
		      <body>
			      <h3 style="color: teal; text-align: center;">Email:  ' . $params['email'] . ', Has requested a password reset</h3>
			      ...
			      <p style="color: teal; font-style: bold; text-align: center;">If this button doesnt work, click this <a href="' . $params['link'] .'">link</a> or paste it in your browser</p>
		      </body>
		      </html>
		    ';
		...
		if (is_array($params) && !empty($params)) {
			...
			*/
			...
			$message = '
		      ...
		      <body>
			      <h3 style="color: teal; text-align: center;">Hello ' . $params['username'] . ', Please verify your account</h3>
			      <p style="color: #333; font-style: bold; text-align: center;">This e-mail was sent automatically by Camagru, if you did not allow this, ignore this email.</p>
			      <a href="' . $params['link'] . '"><button class="button button1">Verify!</button></a>
			      <p style="color: black; font-style: bold; text-align: center;">If this button doesnt work, click this <a href="' . $params['link'] .'">link</a> or paste it in your browser</p>
		      </body>
		      </html>
		    ';
	...
	private function send_mail($to, $subject, $message, $html = false)
	{
		...
		*/
		...
		if ($html)
		{
		  ...
		  $headers[] = 'From: Camagru Team <ftait@student.wethinkcode.co.za>';
		  $headers[] = 'Bcc: ftait@student.wethinkcode.co.za';
		}
		else
		{
		  $headers = 'From: Camagru Developer Team <ftait@student.wethinkcode.co.za>' .
		                "\r\n" .
